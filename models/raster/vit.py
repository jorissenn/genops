# Code from https://github.com/lucidrains/vit-pytorch
...
class ViT(nn.Module):
    def __init__(self, *, 
        ...
        self.classification_heads = nn.ModuleList([ClassificationHeadRaster(n_input_features=dim, n_classes=1) for _ in range(num_classes)])
