...
def predict_raster_elimination(elimination_model, path_to_raster_data, uuid, attach_roads, threshold, device):
...
def predict_raster_selection(selection_model, path_to_raster_data, uuid, attach_roads, thresholds, device):
