...
def get_metrics_raster(model, dataloader, operators_to_pred, threshold, device):
    '''Given a trained raster model, a dataloader, some operators to predict and a threshold, 
