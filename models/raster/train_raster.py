...
def train_raster_model(model, device, optimizer, criterion, n_epochs, batch_size, validate, training_set, validation_set, shuffle_training_set, shuffle_validation_set):
