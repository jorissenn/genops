...
def train_multimodal_model(model, device, optimizer, criterion, n_epochs, batch_size, validate, training_set, validation_set, shuffle_training_set, shuffle_validation_set):
	# creating DataLoaders
	training_loader = DataLoader(dataset=training_set, batch_size=batch_size, shuffle=shuffle_training_set, collate_fn=collate_raster_vector)
	if validate:
		validation_loader = DataLoader(dataset=validation_set, batch_size=batch_size, shuffle=shuffle_validation_set, collate_fn=collate_raster_vector)
